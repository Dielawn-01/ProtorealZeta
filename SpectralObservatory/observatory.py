...
with col_stat:
    ...
    m1, m2 = st.columns(2)
    m1.metric("Lean Modules", "90", delta="0 sorry", delta_color="normal")
...
<div style="text-align: center; color: #667; font-family: 'JetBrains Mono', monospace; font-size: 0.8rem; padding: 20px;">
    ...
    Status: <b>Total Formalization Verified</b> | 90 Lean Modules · 11 Rust Modules · 103 Tests · 0 Sorry<br>
