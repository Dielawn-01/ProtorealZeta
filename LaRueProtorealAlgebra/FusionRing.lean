...
theorem left_unit (u : ProtorealManifold) :
  ...
  unfold e1 ProtorealManifold.mul; ext <;> simp <;> ring
...
theorem f_ωω : ProtorealManifold.mul eω eω =
  ...
  unfold eω omega ProtorealManifold.mul; ext <;> simp <;> ring

theorem f_ωι : ProtorealManifold.mul eω eι =
    { a := -1, b := 0, m := 0, e := 0, l := 0 } := by
  unfold eω eι omega iota ProtorealManifold.mul; ext <;> simp <;> ring

theorem f_ωε : ProtorealManifold.mul eω eE =
    { a := 0, b := 0, m := 0, e := 0, l := 0 } := by
  unfold eω eE omega ProtorealManifold.mul; ext <;> simp <;> ring

theorem f_wL : ProtorealManifold.mul eω eL =
    { a := 0, b := 0, m := 0, e := 0, l := 0 } := by
  unfold eω eL omega ProtorealManifold.mul; ext <;> simp <;> ring

-- Row: ι · {ω, ι, ε, λ}
theorem f_ιω : ProtorealManifold.mul eι eω =
    { a := 1, b := 0, m := 0, e := 0, l := 0 } := by
  unfold eι eω iota omega ProtorealManifold.mul; ext <;> simp <;> ring

theorem f_ιι : ProtorealManifold.mul eι eι =
    { a := 0, b := 0, m := -1, e := 0, l := 0 } := by
  unfold eι iota ProtorealManifold.mul; ext <;> simp <;> ring

theorem f_ιε : ProtorealManifold.mul eι eE =
    { a := 0, b := 0, m := 0, e := 0, l := 0 } := by
  unfold eι eE iota ProtorealManifold.mul; ext <;> simp <;> ring

theorem f_iL : ProtorealManifold.mul eι eL =
    { a := 0, b := 0, m := 0, e := 0, l := 0 } := by
  unfold eι eL iota ProtorealManifold.mul; ext <;> simp <;> ring

-- Row: ε · {ω, ι, ε, λ}
theorem f_ew : ProtorealManifold.mul eE eω =
    { a := 0, b := 0, m := 0, e := 0, l := 0 } := by
  unfold eE eω omega ProtorealManifold.mul; ext <;> simp <;> ring

theorem f_ei : ProtorealManifold.mul eE eι =
    { a := 0, b := 0, m := 0, e := 0, l := 0 } := by
  unfold eE eι iota ProtorealManifold.mul; ext <;> simp <;> ring

theorem f_ee : ProtorealManifold.mul eE eE =
    { a := 0, b := 0, m := 0, e := 1, l := 0 } := by
  unfold eE ProtorealManifold.mul; ext <;> simp <;> ring

theorem f_eL : ProtorealManifold.mul eE eL =
    { a := -1, b := 0, m := 0, e := 0, l := 0 } := by
  unfold eE eL ProtorealManifold.mul; ext <;> simp <;> ring

-- Row: λ · {ω, ι, ε, λ}
theorem f_Lw : ProtorealManifold.mul eL eω =
    { a := 0, b := 0, m := 0, e := 0, l := 0 } := by
  unfold eL eω omega ProtorealManifold.mul; ext <;> simp <;> ring

theorem f_Li : ProtorealManifold.mul eL eι =
    { a := 0, b := 0, m := 0, e := 0, l := 0 } := by
  unfold eL eι iota ProtorealManifold.mul; ext <;> simp <;> ring

theorem f_Le : ProtorealManifold.mul eL eE =
    { a := 1, b := 0, m := 0, e := 0, l := 0 } := by
  unfold eL eE ProtorealManifold.mul; ext <;> simp <;> ring

theorem f_LL : ProtorealManifold.mul eL eL =
    { a := 0, b := 0, m := 0, e := 0, l := 1 } := by
  unfold eL ProtorealManifold.mul; ext <;> simp <;> ring
